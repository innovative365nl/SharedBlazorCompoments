...
public interface IInnovativeSidePanelService
{
    ...
    /// </summary>
    Task OpenInEditMode<T>(T model, bool showClose = true, bool showDelete = false, string? dataTestId = null, bool closeOnSaveForm = false, bool isNewModel = false, string? width = null) where T : class;
...
) : IInnovativeSidePanelService
{
    ...
    public async Task OpenInEditMode<T>(T model, bool showClose = true, bool showDelete = false, string? dataTestId = null, bool closeOnSaveForm = false, bool isNewModel = true, string? width = null) where T : class
    {
    ...
    public async Task OpenInDisplayMode<T>(T model, bool showEdit = true, bool showClose = true, bool showDelete = false,  string? dataTestId = null, string? width = null) where T : class
    {
